<?php
    ...
    switch($_POST['action']){
        ...
        case 2:
            ...
            $myupdate = "UPDATE inventory SET in_quantity = in_quantity + 1 WHERE in_it_id = " . $_POST['id'] . " AND in_ve_id IS NULL";
        ...
        case 3:
            ...
            $myupdate = "UPDATE inventory SET in_quantity = in_quantity - 1 WHERE in_it_id = " . $_POST['id'] . " AND in_ve_id IS NULL AND in_quantity > 0";
            $mysql_link->query($myupdate);
            if($mysql_link->affected_rows == 1){
                echo "Success";
            }
